...
import { fieldInputClasses } from "@/components/ui";
  ...
  return (
    <div className="relative">
      <input
        ...
        className={`${fieldInputClasses} pr-10 ${props.className ?? ""}`}
      />
      <button
        type="button"
        ...
        className="absolute inset-y-0 right-0 flex cursor-pointer items-center px-3 text-zinc-400 transition-colors hover:text-zinc-600 dark:text-zinc-500 dark:hover:text-zinc-300"
      >
